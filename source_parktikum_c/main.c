...
*/
	...
	testtext_ = read_text_file("/home/felix/git/spp/SPP_Uebungen/source_parktikum_c/text4.txt",16000);
	...
	#pragma omp parallel for private(i) reduction(+: counter_) num_threads(4)
